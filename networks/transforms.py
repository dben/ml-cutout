...
def dt(a):
    ...
    :return: the distance transform of a.
    """
...
def trimap_transform(trimap, L=320):
    """
    Transform trimap to the same size as the input image.
    :param trimap: two channel trimap, first background then foreground. Dimensions: (h, w, 2)
    :param L: the size of the output image.
    :return: the transformed trimap.
    """
    clicks = []
    for k in range(2):
